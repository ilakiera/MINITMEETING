...
<center>
<br>
<form action="deleteOrderEng.php" method="post">
...
<tr>
<td>Quantity</td>
<td>: <?php echo $data["quantity"];?><input type="hidden" name="quantity" style="width:50;" value="<?php echo $data["quantity"];?>"></td>
</tr>
</table>
<center>
<input type="submit" value="DELETE ORDER" style="width:140; height:25; background:#F99">
<a href="viewOrder.php"><input type="button" value="BACK" name="edit" style="width:140; height:25; background:#F99"></a></center></form></center>
<?php
}
else
{
