...
$sql = "SELECT * FROM customer WHERE userId = '".$id."'";
...
<tr><td colspan="3"><font size="10" face="Ar Darling"><?php echo $id;?> ProFile</font> <img src="resource/InLove-48.png" width="48" height="48"></td></tr>
<tr bgcolor="#FCC">
<td>
...
<td><?php echo $id;?><input type="hidden" name="id" value="<?php echo $id;?>"></td></tr>
<tr bgcolor="#FCC">
<td>
PASSWORD </td><td bgcolor="#FF9999">:</td>
<td><?php echo $data["password"];?><input type="hidden" name="pass" value="<?php echo $data["password"];?>"></td></tr>
</table></center>
<center>
<a href="viewCusProfil.php"><input type="button" value="BACK" name="edit" style="width:70; height:25; background:#F99"></a></center>
</font>
<?php
}
else
